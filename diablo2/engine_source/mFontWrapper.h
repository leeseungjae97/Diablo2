...
#ifdef _DEBUG
#pragma comment(lib, "..\\External\\FW1FontWrapper\\_Library\\Debug_\\FW1FontWrapperL.lib")
#else
#pragma comment(lib, "..\\External\\FW1FontWrapper\\_Library\\Debug_\\FW1FontWrapper.lib")
#endif
